                    ...
                    Container(
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(title[0], style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16, color: Colors.white),),
                        ),
                      ),
                    ),
                  ],
                  ...
                  children: <Widget>[
                    Container(
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(title[1], style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16, color: Colors.white),),
                        ),
                      ),
                    ),
                  ],
